...
SECRET_KEY = 'django-insecure-!=0fa=i^3ox1*^g9frhciddy+^@apav02=^2$k%0eu*jl_t!-b'
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'testing.second12@gmail.com'    # This is the sender Email 
...
EMAIL_HOST_PASSWORD = 'kfzrsldbrgvudigk'              # This is the password for sender Email
...
STATIC_URL = 'static/'
# MEDIA_URL and MEDIA_ROOT are created to store uploaded files like images or any other type or files
# media => is the name of folder in which images will be stored 
MEDIA_URL = '/media/'
